...
export const NOTIFICATION_GRANT_ANSWER_REQUEST =
  'NOTIFICATION_GRANT_ANSWER_REQUEST'
export const NOTIFICATION_GRANT_ANSWER_SUCCESS =
  'NOTIFICATION_GRANT_ANSWER_SUCCESS'
export const NOTIFICATION_GRANT_ANSWER_FAIL = 'NOTIFICATION_GRANT_ANSWER_FAIL'
export const NOTIFICATION_GRANT_ANSWER_RESET = 'NOTIFICATION_GRANT_ANSWER_RESET'
